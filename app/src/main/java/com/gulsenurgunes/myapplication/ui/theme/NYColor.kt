...
val onPrimaryDark = Color(0xFF000000) // Primary üzerinde metin rengi
val primaryContainerDark = Color(0xFF73A857) // Primary container rengi
val onPrimaryContainerDark = Color(0xFF074932) // Primary container üzerindeki metin rengi
val secondaryDark = Color(0xFFB26A00) // İkincil renk
val errorDark = Color(0xFFFFB4AB) // Hata rengti
val onErrorDark = Color(0xFF690005) // Hata rengi üzerindeki metin
val errorContainerDark = Color(0xFF93000A) // Hata alanı rengi
val onErrorContainerDark = Color(0xFFFFDAD6) // Hata alanı üzerindeki metin rengi
val backgroundDark = Color(0xFF2C2C2C) // Sayfa arka planı (dark)
val onBackgroundDark = Color(0xFFE4E1E9)
val cardBackgroundDark = Color(0xFF1E1E1E) // Kart arka planı (dark)
val onCardBackgroundDark = Color(0xFFE4E1E9) // Kart üzerindeki metin rengi
